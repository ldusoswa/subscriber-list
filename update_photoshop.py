...
def main():
    ...
    print()
    print("=" * 60)
    print("IMPORTANT: Action Setup Required")
    print("=" * 60)
    print()
    print("Before running this script, create a Photoshop action:")
    print()
    print("1. Open Photoshop")
    print("2. Window > Actions")
    ...
    print("   - Save to: C:\\Users\\dusosl\\Dropbox\\Youtube\\Patreon6.jpg")
    print("7. Stop Recording")
    print()
    print("=" * 60)
    print()
    
    response = input("Have you created the 'UpdatePatreon' action? (y/n): ")
    if response.lower() != 'y':
        print()
        print("Please create the action first, then run this script again.")
        sys.exit(0)
